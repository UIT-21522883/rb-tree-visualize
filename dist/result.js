...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _rbtree = __webpack_require__(333);
	...
	function handlerAdd(e) {
	  ...
	  tree = new _tree.Tree(rbTreeList);
	  console.log(tree);
	  tree.display();
	}
	...
	function handlerDel(e) {
	  ...
	  rbTreeList = (0, _rbtree.remove)(rbTreeList, parseInt(n, 10));
	  inputForDel.value = '';
	...
	function add(tree, value) {
	  ...
	  while (currentNode.color === _constants.RED && currentNode.parent && currentNode.parent.color === _constants.RED) {
	    ...
	    if (!uncle || uncle.color === _constants.BLACK) {
	      var sideOfTree = void 0,
	          anotherDir = void 0;
	      if (parent === grandFather.left) {
	        sideOfTree = _constants.LEFT;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var rotate = function rotate(node, direction) {
	  var anotherDir = void 0;
	  if (direction === _constants.LEFT) {
	    anotherDir = _constants.RIGHT;
	  } else {
	    anotherDir = _constants.LEFT;
	  }
	  ...
	  if (grandFather) {
	    var sideGrandfather = void 0;
	    if (grandFather.left === parent) {
	      sideGrandfather = _constants.LEFT;
	    } else {
	      sideGrandfather = _constants.RIGHT;
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _node = __webpack_require__(337);
